...
namespace Visao
{
    public partial class CadastroBeneficios : Form
    {
        public CadastroBeneficios()
        {
            InitializeComponent();
            BeneficioCadastro grp = new BeneficioCadastro(
                btnSalvar,
                btnCancelar,
                this,
                beneficiosGridView);
        ...
        private void CadastroBeneficios_Load(object sender, EventArgs e)
        {
