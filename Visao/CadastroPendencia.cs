...
namespace Visao
{
    public partial class CadastroPendencia : Form
    {
        public CadastroPendencia()
        {
            InitializeComponent();
    
            PendenciaCadastro pen = new PendenciaCadastro(
                btnAdicionar,
                btnLimpar,
                btnSalvar,
                btnCancelar,
            ...
            pendenciaGridView.CellMouseDown += GridView_CellMouseDown;
        ...
        private void CadastroPendencia_Load(object sender, EventArgs e)
        {
